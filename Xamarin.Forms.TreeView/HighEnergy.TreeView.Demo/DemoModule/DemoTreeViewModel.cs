...
namespace HighEnergy.TreeView.Demo
{
    public class DemoTreeViewModel : ObservableObject
    {
        ...
        public DemoTreeViewModel()
        {
            ...
            var a = MyTree.Children.Add(new DemoTreeNode { Title = "Tdasdm,sdlnfd,smnfdbsd,m.fnbsdfbd,bf.asdfjbd,.smbf.abf,.amsdbf.dmsbnf.asdmbf.sdm ,mb keflswfAdEHWELFBSDMLFBpñKAJSBEIWUMKASNBERFSDNBñiekeiw", Score = 0.75, IsExpanded = true });
